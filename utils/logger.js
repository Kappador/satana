...
function info(log) {
    console.log(`${fg.red}  |> ${endColor}${bg.cyan}[${timestamp()}]${endColor}${fg.cyan} | ${log}${endColor}`);
}
...
function line() {
    console.log(`${fg.black} ______________________________________________________________________________________________${endColor}\n`);
}
module.exports = {
    error, info, success, warning, line
};